    ...
    <section className="relative pt-32 pb-20 bg-primary overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            <Compass className="w-4 h-4 text-consulting" />
            <span className="text-consulting text-sm font-medium">Strategic Analysis</span>
          </motion.div>
          ...
          >
            Strategic analysis to determine the optimal use of land and properties, maximizing value and return on
            investment for developers and investors.
          </motion.p>
